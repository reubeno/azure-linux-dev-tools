...
## azldev advanced plugin info

Show full detail for one loaded plugin

```
azldev advanced plugin info <plugin-name> [flags]
```
...
* [azldev advanced plugin](azldev_advanced_plugin.md)	 - Inspect plugins loaded for this azldev invocation
